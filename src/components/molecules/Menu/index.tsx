          ...
          <MenuItem flex='3' align='center'>
            {
              ...
              links.map(i => {
                return (
                  <MenuItem clickable={true} gap='12px' key={'menu-item-' + uuidv4()} flex='1' align='center' onClick={() => i.onAction(i.path)}>
            ...
            }
            {
              toggle != null &&
                <MenuItem flex='1' align='center'>
                    <Toggle key={'toggle-' + uuidv4()} isActive={toggle.isActive} toggle={toggle.toggle} labelText={toggle.labelText} variant={toggle.variant}/>
                </MenuItem>
            }
          </MenuItem>
        ...
        <MenuBody show={menuBurger}>
          ...
          </MenuItem>
          {
            ...
            links.map(i => {
              return (
                <MenuBodyItem>
                  <MenuItem clickable={true} gap='12px' padding='8px 24px' key={'menu-item-' + uuidv4()} flex='1' align='left' onClick={() => i.onAction(i.path)}>
                    <img src={i.icon}  width='24' height='24' alt={`${title} left icon`}/>
                    <MenuItemWrapped>
                      {i.page}
                    </MenuItemWrapped>
