...
Default.args = {
    ...
    links: routes,
    menuIcon: casperIcon,
    rightOptionAction: rightAction,
    rightConnectionAction: rightActionConnected2,
    toggle: toggleAction,
...
WalletConnected.args = {
    ...
    links: routes,
    menuIcon: casperIcon,
    rightOptionAction: rightAction2,
    rightConnectionAction: rightActionConnected,
    toggle: toggleAction,
    menuBackground: 'default',
    isWalletConnected: true,
    handleRedirect: () => console.log('handleRedirect')
