...
*/
export declare const HorizontalCard: ({ icon, tokenPairs, pairsLiquidity, userPoolInfo, hasFavorite, trashHandler, swapHandler, viewHandler, itemHandler, addLiquidityHandler, favoriteHandler }: HorizontalCardProps) => JSX.Element;
