...
*/
export declare const HorizontalCard: ({ networkLink, contractPackage, firstTokenIcon, secondTokenIcon, tokenPairs, pairsLiquidity, userPoolInfo, hasFavorite, trashHandler, swapHandler, viewHandler, itemHandler, stakeHandler, unstakeHandler, claimHandlerWETH, claimHandlerCST, addLiquidityHandler, favoriteHandler, toggleDialog, actionsDialogActive, hasBalance, hasStake, hasGauge, rewardETHTitle, rewardCSTTitle, hasClaimWETH, hasClaimCST, }: HorizontalCardProps) => React.JSX.Element;
