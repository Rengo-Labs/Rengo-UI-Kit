...
*/
export declare const HorizontalCard: ({ networkLink, contractPackage, firstTokenIcon, secondTokenIcon, tokenPairs, pairsLiquidity, userPoolInfo, hasFavorite, trashHandler, swapHandler, viewHandler, itemHandler, stakeHandler, unstakeHandler, claimHandler, addLiquidityHandler, favoriteHandler, toggleDialog, actionsDialogActive, hasStake }: HorizontalCardProps) => React.JSX.Element;
