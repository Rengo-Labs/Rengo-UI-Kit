 ...
 */
export declare const AccountTransferBody: ({ id, deploy_hash, block_hash, antiquity, of, forValue, transference_id, amount, price, widthIcon, heightIcon }: IAccountTransferBody) => JSX.Element;
