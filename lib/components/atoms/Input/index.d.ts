 ...
 */
export declare const Input: ({ placeholder, status, type, label, helperText, rightAdornment, hasBackground, Icon, iconSize, iconWrapperBackground, onChange, validator, value, textAlign, disabled }: InputProps) => React.JSX.Element;
